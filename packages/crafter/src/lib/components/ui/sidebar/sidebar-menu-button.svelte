...
<script lang="ts">
	...
	// Components from @ujl-framework/ui are exported with full names (e.g., Tooltip, TooltipContent)
	// but the codebase uses namespace-style access (e.g., Tooltip.Root, Tooltip.Content)
