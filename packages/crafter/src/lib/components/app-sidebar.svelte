<script lang="ts" module>
	...
	// TODO: Replace with actual data source in production
	const data = {
		user: {
			name: 'shadcn',
			email: 'm@example.com',
...
<Sidebar.Root
	...
	{...restProps}
>
	<!-- First sidebar: Icon-only navigation sidebar -->
	<!-- Disabled collapsible behavior and set width to icon size -->
	<!-- This creates the icon-only appearance when collapsed -->
	...
	<!-- Second sidebar: Content sidebar with mail list -->
	<!-- Disabled collapsible behavior and let it fill remaining space -->
